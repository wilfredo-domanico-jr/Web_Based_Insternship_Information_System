...
echo '<title>Notifications - Company</title>';
?>
                        ...
                        <div class="card violet mb-4">
                            ...
                            <div class="card-body-class">
                                        ...
                                        <?php 
                                                    ...
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_interview where (class ='$myid' OR class = '$join_code') AND msg_delete != 1 ORDER BY msg_read ASC");
                                                    $stmt->execute();
                                                    ...
                                                    ?>
                                                            ...
                                                            <?php include 'constants/notif.php';?>
