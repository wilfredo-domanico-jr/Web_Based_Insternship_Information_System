...
echo '<title>Declined Applications - Company</title>';
?>
<style>
  #interview{
    background:#fff;
    color:#2b7a78;
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class = "mt-4 mb-4 contact-us">
                            ...
                            <h1 class="title-page">Declined Applications</h1>
                             </div> 
                        ...
                        <div class="card violet mb-4">
                            ...
                            <div class="card-body-class">
                                ...
                                <?php
                                        ...
                                        where company ='$myid' and application_status ='DECLINED'");
                                        ...
                                        if($count == 0){
                                            ...
                                            <h3><strong>NO DECLINED APPLICATIONS</strong></h3>
                                        ...
                                        <tr>                                                                                                       
                                                    ...
                                                    <td>
                                                            ...
                                                            $link = $conn->prepare("SELECT * FROM tbl_interview where internship_id ='$intrnsp_id' AND stud_id ='$member_id' AND status ='DECLINED'");
                                                            $link->execute();
