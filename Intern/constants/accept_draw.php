...
<span style="color:#fff;font-size:2vmin"><i class="fa-solid fa-bell"></i> CONGRATULATIONS!!</span>
                                                            ...
                                                            <br>
                                                                ...
                                                                <div class="modal-header header-modal-color">
                                                                    <h5 style="color:#fff;" class="modal-title " id="uploadModalLabel">You've been Accepted</h5>
...
<div>
    ...
    <p>Congratulations for passing the interview<br>
    <b>We want you to be part of our team!</b><br><br>

   
    Here is your Joining code : <span style="color:red;"><b><u><?php echo $row['jn_code'];?></u></b></span>
</p>
