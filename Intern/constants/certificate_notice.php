...
<span style="color:#fff;font-size:2vmin;"><i class="fa-solid fa-bell"></i> CERTIFICATE</span>
                                                            ...
                                                            <br>
                                                                ...
                                                                <div class="modal-header header-modal-color">
                                                                    <h5 class="modal-title text-light" style="color:#fff;" id="uploadModalLabel">Certificate</h5>
...
<div>
    ...
    <p>We whould like to congratulate you for completing <b>478 hours</b> of Internship <br><br>
    
    
    Here's your Certificate: <br><br>  

    <!------- eto yung kulang ------------> 
    <a class="btn btn-success" href="../files/intern/certificate/<?php echo $row['certificate']?>" download="Certificate"><i class="fa-solid fa-certificate"></i> Download Certificate</a>
