                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card violet mb-4">
                            <div class="card-header-class">
                                ...
                                <a class ="heading-stream">STREAM</a>
                                    <a class ="heading-document">DOCUMENTS</a>
                                    <a class ="heading-class">CLASS</a>
                                    ...
                                    <div class ="stream-content2">
                                        ...
                                        <?php
                                            if($stud_section == null){
                                                ...
                                                echo '<div class="alert alert-dark" role="alert">YOU HAVE NO CLASS JOINED YET <a href =""data-toggle="modal" data-target="#displayClassJoin">Click HERE to Join Class</a> </div>';
                                            }

                                            
                                            else{
                                                include 'constants/display-announcement.php';
                                            }
                                        ?>
                            ...
                            <?php
                                                    if($stud_section == null){
                                                        ...
                                                        echo '<div class="alert alert-dark" role="alert">YOU HAVE NO CLASS JOINED YET <a href =""data-toggle="modal" data-target="#displayClassJoin3">Click HERE to Join Class</a> </div>';
                                                   
                                                    }

                                                    else{include 'constants/draw-class-list.php';}
                        ...
                        <!--------------------------------------->
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 style="color:#fff;" class="modal-title" id="displayClassJoinTitle">JOIN CLASS</h5>
                                                    ...
                                                    <!--------MODAL FOR CLASS JOIN2---->


                                                <!-- Modal -->
                                                <div class="modal fade" id="displayClassJoin2" tabindex="-1" role="dialog" aria-labelledby="displayClassJoinTitle2" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="color:#fff;"class="modal-title" id="displayClassJoinTitle2">JOIN CLASS</h5>
                                                            <button style="color:#fff;" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <!--------MODAL FOR CLASS JOIN3---->


                                                <!-- Modal -->
                                                <div class="modal fade" id="displayClassJoin3" tabindex="-1" role="dialog" aria-labelledby="displayClassJoinTitle3" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="color:#fff;" class="modal-title" id="displayClassJoinTitle3">JOIN CLASS</h5>
                                                            <button style="color:#fff;" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
