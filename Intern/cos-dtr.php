                        ...
                        <div class="card violet mb-4">
                            <div class="card-header-class">
                                <center>
                                    ...
                                    <a href ="cos-internship.php" class ="heading-document">My Company</a>
                                    <a href ="cos-dtr.php" class ="heading-stream" >DTR</a>
                                </center>
                            </div>
                                     ...
                                     <br>
                                                         ...
                                                         <?php
                                                                            if($stud_company == null){
                                                                                ...
                                                                                include 'constants/draw_dtr_cos.php';
                     ...
                     <!----------------------------MODALS---------------------->
                                                                            ...
                                                                            <!-- Modal FOR UPLOAD DTR---->
                                                                                            ...
                                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                                ...
                                                                                                <form action="app/add-dtr-cos.php" method="POST" enctype="multipart/form-data">
