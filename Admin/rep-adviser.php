...
echo '<title>Advisers Repository - Admin</title>';
...
<style>
    ...
    <div class="container-fluid px-4">
        <div class = "mt-4 mb-4 contact-us">
            ...
            <h1 class="title-page">Advisers</h1>
            ...
            <?php include 'constants/check_reply.php';?>
                  ...
                  <div class = "tbl-container">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role ='Adviser' and status =0");
                                    $stmt->execute();
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td><center><?php echo $row['member_no']; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="outer-container">
                <div class="row">
                    <form class="form-horizontal" action="app/import-adviser.php" method="post"
                        name="frmExcelImport" id="frmExcelImport"
                        enctype="multipart/form-data" onsubmit="return validateFile()">
                        <div Class="input-row">

                        <label>Choose your file. <a href="Template/adviser-template.xlsx"
