                                                                ...
                                                                <div class="row top5">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-9">
                                                                                                    ...
                                                                                                    <div class="col-sm-2 col-md-3">
                                                                                                                        ...
                                                                                                                        <div class="form-group">
                                                                                                                            <label class ="heading">Student No.:</label><br>
                                                                                                                ...
                                                                                                                <div class="col-sm-2 col-md-3">
                                                                                                                        ...
                                                                                                                        <div class="form-group">
                                                                                                                            <label class ="heading">Age:</label><br>
                                                                                                                            <span class ="details"><?php echo $row['age']; ?></span>
                                                                                                    ...
                                                                                                    <div class ="row top5">
                                                                                                                ...
                                                                                                                <div class="col-sm-6 col-md-3">
                                                                                                                            ...
                                                                                                                            <div class="form-group">
                                                                                                                                <label class ="heading">Hours Rendered:</label><br>
                                                                                                                                <span class ="details"><?php echo $row['student_ojthours'];?></span>
                                                                                                                            </div>
                                                                                                                ...
                                                                                                                <div class="col-sm-2 col-md-4">
                                                                                                                        ...
                                                                                                                        <div class="form-group"> 
                                                                                                                            ...
                                                                                                                            <?php
                                                                                                                                    ...
                                                                                                                                    if($count_com == 0){echo '<span class ="details">NO COMPANY</span>';}
                                                                                                    ...
                                                                                                    <div class ="row top5">
                                                                                                                ...
                                                                                                                <div class="col-sm-12 col-md-12">
                                                                                                                    ...
                                                                                                                    <div class="form-group bootstrap3-wysihtml5-wrapper">
                                                                                                                        <label class ="heading">About</label><br><br>
