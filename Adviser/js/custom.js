...
$(document).ready(function(){
  ...
  $(".pending").click(function(){
          ...
          $(".declined-docs").hide();
        $(".late-docs").hide();
          //PAG ADD NG BOTTOM LINE AFTER I CLICK
          $(".pending").css("border-bottom", "5px solid var(--header-title-font)");
          $(".approved").css("border-bottom", "none");
          $(".declined").css("border-bottom", "none");
  $(".late").css("border-bottom", "none");
  });
  ...
  $(".approved").click(function(){
   ...
   $(".late-docs").hide();
    //PAG ADD NG BOTTOM LINE AFTER I CLICK
    $(".approved").css("border-bottom", "5px solid var(--header-title-font)");
    $(".pending").css("border-bottom", "none");
    $(".declined").css("border-bottom", "none");
  $(".late").css("border-bottom", "none");
});
});
...
$(".declined").click(function(){
  ...
  $(".pending").css("border-bottom", "none");
  $(".late").css("border-bottom", "none");
  $(".declined").css("border-bottom", "5px solid var(--header-title-font)");
});
...
$(".late").click(function(){
  ...
  $(".pending").css("border-bottom", "none");
  $(".declined").css("border-bottom", "none");
  $(".late").css("border-bottom", "5px solid var(--header-title-font)");
});
