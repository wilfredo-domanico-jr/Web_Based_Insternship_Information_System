        ...
        <div class="card mb-4">
            <div class="card-header-class">
                ...
                <center>
                    ...
                    <h1 class ="heading-stream">STREAM</h1>
                    <h1 class ="heading-document">DOCUMENTS</h1>
                    <h1 class ="heading-class">CLASS</h1>
                </center>
            </div>
            ...
            <?php include 'constants/check_reply.php'; ?>
                    ...
                    <br>
                                                        ...
                                                        <?php
                                                                        ...
                                                                        if($count_announcement == 0){echo 'NO ANNOUNCEMENTS';}
                                                                                                ...
                                                                                                <div class="modal-dialog modal-lg">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        <form action="app/edit_announcement.php" method="POST" autocomplete="off">
                                                                                                                ...
                                                                                                                <button class ="btn btn-success">&nbsp;&nbsp;<i class="fas fa-bullhorn"></i> Edit Announcement</button>
