...
$title = $_POST['title'];//
	...
	if ($rec == "0") {
    $stmt = $conn->prepare("UPDATE tbl_users SET first_name = :fname,title = :mytitle,last_name = :lname, city = :city, street = :street, zip = :zip, phone = :phone, about = :about WHERE member_no='$myid'");
